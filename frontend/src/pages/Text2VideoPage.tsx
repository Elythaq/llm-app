...
export default function Text2VideoPage({ sidebarOpen = true }: { sidebarOpen?: boolean }) {
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: "assistant", content: "How can I help you with Text to Video today?" }
  ]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-[#3a2c50] via-[#b06ab3] to-[#ff61a6] py-10">
      <div className="
        w-full
        max-w-3xl
        min-h-[80vh]
